        ...
        child: ListView(
          children: <Widget>[
            Padding(
              ...
              child: Text("Good job completing Level One! Now we will learn how to make Orca turn right. Lift up your left and right hand: Orca should look at your right hand when it turns right, like this:"),
            ),
            Container(
                width: 500,
                height: 400,
                child: Image.asset('assets/images/game/turn_right.jpg')
            ),
            Padding(
            ...
            Padding(
              padding: const EdgeInsets.fromLTRB(45.0, 40.0, 0.0, 20.0),
              child: Text("Help Orca reach the finish line!", style: AchievementsTitleTextStyle,),
            ),
            Container(
                width: 500,
                height: 400,
                child: _count == 1 ? Image.asset('assets/images/game/2/2_2.jpg')
                    : _count == 3 ? Image.asset('assets/images/game/2/2_3.jpg')
                : _count == 4 ? Image.asset('assets/images/game/2/2_4.jpg')
                : Image.asset('assets/images/game/2/2_1.jpg')
            ),
            Container(
              width: 500,
              height: 25,
            ...
            Container(
                width: 400,
                height: 320,
                child: _count == 1 ? Image.asset('assets/images/game/2/b2.jpg')
                    : _count == 3 ? Image.asset('assets/images/game/2/b3.jpg')
                    : _count == 4 ? Image.asset('assets/images/game/2/b4.jpg')
                    : Image.asset('assets/images/game/2/b1.jpg')
            ),
            Container(
              width: 500,
              height: 25,
